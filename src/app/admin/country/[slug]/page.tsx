...
const CountryEditPage = () => {
  ...
  //     if (country) {
  //       response = await dispatch(
  //         updateCountry({ id: country.id, data: values }),
  //       );
  //     } else {
  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-white shadow-md rounded-2xl mt-8">
      ...
      <div className="flex items-center gap-4 border-b border-gray-200 pb-4 mb-6">
        <button
          onClick={() => router.back()}
          className="px-2 py-1.5 text-sm font-semibold cursor-pointer  text-gray-700 rounded-lg hover:bg-gray-300 transition"
        >
          <FaArrowLeft size={24} />
        </button>
          ...
          <Form className="space-y-6">
            ...
            <div className="border-t pt-6">
              ...
              <div className="mb-4">
                ...
                <Field
                  name="metaTitle"
                  type="text"
                  placeholder="Norway eSIM | Buy Norway Travel eSIM"
                  className="w-full px-4 py-2 rounded-lg bg-gray-100 text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500"
                />
              </div>
              ...
              <div className="mb-4">
                ...
                <Field
                  ...
                  rows={3}
                  placeholder="Get Norway eSIM with instant activation..."
                  className="w-full px-4 py-2 rounded-lg bg-gray-100 text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setFieldValue("keywordInput", e.target.value)
                    }
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      setFieldValue("metaKeywords", updated);
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  {values.metaKeywords?.map(
                    (keyword: string, index: number) => (
                      <div
                        key={index}
                        className="flex items-center gap-2 px-3 py-1 bg-gray-200 text-black rounded-full"
                      >
                        <span>{keyword}</span>
                        ...
                        <button
                          type="button"
                          onClick={() => {
                            const updated = values.metaKeywords.filter(
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
              <button
                ...
                className="px-6 py-2 rounded-lg cursor-pointer font-semibold bg-gray-200 text-gray-700 hover:bg-gray-300 transition"
              >
                Cancel
              </button>
              <button
                ...
                className="px-6 py-2 font-bold cursor-pointer rounded-lg bg-green-600 text-white hover:bg-green-700 transition flex items-center gap-2"
              >
                {isSubmitting && (
                  <svg
