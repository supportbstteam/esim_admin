    ...
    return (
        <>
            ...
            */}
            ...
            <div
                className={`px-6 border-b bg-white sticky top-0 z-40 ${
                    isSticky 
                ...
                <div className={`grid gap-3 mx-auto ${
                    ...
                    {templates.map((t) => (
                        <div
                            ...
                            className={`cursor-pointer border rounded-md group flex flex-col items-center justify-center overflow-hidden ${
                                isSticky
                        ...
                        >
                            ...
                            <h4 className={`font-bold text-black text-center truncate px-1 ${
                                isSticky ? "text-[14px] uppercase tracking-tighter" : "text-xs"
                            }`}>
                                {t.title}
                            </h4>
                        </div>
