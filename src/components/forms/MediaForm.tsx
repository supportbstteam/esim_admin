        ...
        {({ values, handleChange, handleSubmit }) => {
          ...
          const apiImage =
            initialData?.filePath
              ? `${process.env.NEXT_PUBLIC_API_URL_IMAGE}/${initialData.filePath}`
              : null;

          const previewSrc = preview || apiImage;
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative group h-72 border-2 border-dashed border-gray-300 rounded-xl flex items-center justify-center overflow-hidden">
