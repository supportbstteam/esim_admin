...
const AddCountryModal: React.FC<AddCountryModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#00000050] backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-2xl p-8 relative flex flex-col gap-6 max-h-[90vh] overflow-y-auto">

        {/* Header */}
        <div className="flex justify-between items-center sticky top-0 bg-white dark:bg-gray-900 z-10 pb-3 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-2xl font-extrabold text-gray-800 dark:text-white">Add Country</h2>
          <button
            onClick={onClose}
            ...
            <Form className="space-y-6">
              ...
              <div>
                ...
                <Field
                  ...
                  className="w-full px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              ...
              {/* ISO Code */}
              <div>
                <label className="block font-semibold text-gray-700 dark:text-gray-200 mb-1">ISO Code</label>
                <Field
                  name="isoCode"
                  type="text"
                  maxLength={2}
                  placeholder="US"
                  className="w-full px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 dark:text-white uppercase placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              ...
              {/* ISO3 Code */}
              <div>
                <label className="block font-semibold text-gray-700 dark:text-gray-200 mb-1">ISO3 Code</label>
                <Field
                  name="iso3Code"
                  type="text"
                  maxLength={3}
              ...
              {/* Currency */}
              <div>
                <label className="block font-semibold text-gray-700 dark:text-gray-200 mb-1">Currency Code</label>
                <Field
                  name="currency"
                  type="text"
                  maxLength={3}
              ...
              {/* Phone Code */}
              <div>
                <label className="block font-semibold text-gray-700 dark:text-gray-200 mb-1">Phone Code</label>
                <Field
                  name="phoneCode"
                  type="text"
                  placeholder="+1"
                  className="w-full px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500"
                />
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label className="text-gray-700 dark:text-gray-200 select-none">Active</label>
              </div>
