...
const PlanDropdown: React.FC<FieldProps & {
    ...
    return (
        <div className="relative" ref={ref}>
            <button
                type="button"
                className={`w-full px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-300 ${disabled ? "cursor-not-allowed opacity-50" : "cursor-pointer hover:bg-green-50 dark:hover:bg-green-900"
                    }`}
...
export const ModalTopupForm: React.FC<ModalPlanFormProps> = ({
    open,
    onClose,
    onSubmit,
}) => {
